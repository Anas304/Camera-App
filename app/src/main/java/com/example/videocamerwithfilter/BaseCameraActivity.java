package com.example.videocamerwithfilter;
...
import com.example.videocamerwithfilter.widget.Filters;
import com.example.videocamerwithfilter.widget.SampleGLView;
...
public class BaseCameraActivity extends AppCompatActivity {
    ...
    protected void onCreateActivity() {
      ...
      /*  recordBtn.setOnClickListener(v -> {
        ...
        recordBtn.setOnClickListener(v -> {
            if (isRecording) {
                recordBtn.setImageResource(R.drawable.ic_start_recording);
                filepath = getVideoFilePath();
                cameraRecorder.start(filepath);
                Toast.makeText(this, "Recording Stopped!", Toast.LENGTH_SHORT).show();
            } else {
                cameraRecorder.stop();
                Toast.makeText(this, "Recording Started!", Toast.LENGTH_SHORT).show();
                recordBtn.setImageResource(R.drawable.ic_stop_recording);
            }
    ...
    private void changeFilter(Filters filters) {
        cameraRecorder.setFilter(Filters.getFilterrInstance(filters, getApplicationContext()));
    }
